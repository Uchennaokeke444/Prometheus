...
// negotiation for version, certain features and compressions, explained in
...
type WriteRequest struct {
	...
	// timeseries represents array of series, potentially from multiple targets.
	// Sorted by labels (not by label refs).
...
type TimeSeries struct {
	...
	// time metric streaming. samples can co exist with histogram samples (histograms
	// field).
	//
	...
	// time metric streaming. histograms can co exist with samples.
	//
	...
	// metrics. NOTE: Servers might negotiate "required-created-timestamp" feature
	// that requires this field to be set for counters and histograms.
